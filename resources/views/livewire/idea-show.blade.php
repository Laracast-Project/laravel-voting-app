        ...
        <div class="flex flex-col md:flex-row items-center space-x-4 md:ml-6">
            <div
                ...
                <div
                    ...
                    @click.away="isOpen = false"
                    @keydown.escape.window="isOpen = false"
                    class="absolute z-10 w-64 md:w-104 text-left font-semibold textsm bg-white shadow-dialog rounded-xl mt-2">
                    <form action="#" class="space-y-4 px-4 py-6">
                        ...
                        <div class="flex flex-col md:flex-row items-center md:space-x-3">
                            ...
                            <button
                                ...
                                text-xs bg-gray-200 font-semibold rounded-xl border border-gray-200
            ...
            <div
                ...
                <button
                    ...
                    w-36 h-11 text-xs bg-gray-200 font-semibold rounded-xl
                    border border-gray-200 hover:border-gray-400 transition duration-150 ease-in px-6
                    py-3 mt-2 md:mt-0"
                ...
                >
                    ...
                    <div
                        ...
                        @click.away="isOpen = false"
                        @keydown.escape.window="isOpen = false"
                        class="absolute z-20 w-64 md:w-76 text-left font-semibold textsm bg-white shadow-dialog rounded-xl mt-2">
                    <form action="#" class="space-y-4 px-4 py-6">
                        <div class="space-y-2">
                            <div>
