        ...
        <div class="flex items-center space-x-4 ml-6">
            <div
                ...
                <div
                    ...
                    @click.away="isOpen = false"
                    @keydown.escape.window="isOpen = false"
                    class="absolute z-10 w-104 text-left font-semibold textsm bg-white shadow-dialog rounded-xl mt-2">
            ...
            <div
                ...
                >
                    ...
                    <div
                        ...
                        @click.away="isOpen = false"
                        @keydown.escape.window="isOpen = false"
                        class="absolute z-20 w-76 text-left font-semibold textsm bg-white shadow-dialog rounded-xl mt-2">
                    <form action="#" class="space-y-4 px-4 py-6">
                        <div class="space-y-2">
                            <div>
