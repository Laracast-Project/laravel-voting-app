...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <main class="container mx-auto max-w-custom flex">
        <div class="w-70 mr-5">
            Add idea form goes here. Lorem ipsum dolor sit amet
            consectetur adipisicing elit. Debitis consequatur officiis architecto
            quis similique velit suscipit eius voluptate officia, repudiandae
        </div>
        <div class="w-175">
