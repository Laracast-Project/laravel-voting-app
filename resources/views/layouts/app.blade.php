        ...
        <div class="w-70 mx-auto md:mx-1 mr-5">
            ...
            >
                <div class="text-center px-2 py-6">
                    <h3 class="font-semibold text-base">Add Idea</h3>
                    <p class="text-xs mt-4">
                        @auth
                            Let us know what you would like and we'll take a lokk over!
                        @else
                ...
                @else
                    <div class="my-6 text-center">
                        ...
                        <a
                            href="{{ route('register') }}"
                            type="submit"
                            class="justify-center mt-3 w-1/2 h-11 text-xs bg-gray-200 font-semibold rounded-xl border border-gray-200 hover:border-gray-400 transition duration-150 ease-in px-6 py-3"
                        >
