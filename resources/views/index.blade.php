<x-app-layout>
    <div class="filters flex space-x-6">
        ...
        <div class="w-2/3 relative">
            <input type="search" placeholder="Find an idea" class="w-full rounded-xl bg-white border-none placeholder-gray-900 px-8 py-2 pl-8">
    ...
    <div class="ideas-container space-y-6 my-6">
        <div class="idea-container hover:shadow-card  bg-white rounded-xl flex cursor-pointer transition duration-150 ease-in">
            ...
            <div class="flex flex-1 px-2 py-6">
                <div class="flex-none">
                    <a href="#">
                        <img src="https://source.unsplash.com/200x200/?face&crop=face&v=1" alt="avartar" class="w-14 h-14 rounded-xl">
                    </a>
                </div>
                <div class="w-full mx-4">
                    <h4 class="text-xl font-semibold">
                        <a href="#" class="hover:underline">
                            A Random title goes in here
                        </a>
                    </h4>
                    <div class="text-gray-600 mt-3 line-clamp-3">
                        Lorem ipsum dolor sit amet, consectetur adipisicing elit. A consequatur inventore minus porro repudiandae, vel. Alias blanditiis natus quas tenetur vero! Ad atque earum eius, error magnam, nostrum perferendis possimus qui quia quidem ratione, rerum sapiente sequi voluptas voluptate. Ad dolor et exercitationem praesentium! Adipisci at beatae corporis deleniti distinctio, fugit, minus modi nam nemo, optio quaerat sequi tenetur! Adipisci esse odit officiis omnis sunt. Asperiores autem blanditiis, deserunt dicta doloribus ducimus exercitationem expedita fugit id iste minus necessitatibus odio odit possimus quae, quisquam ratione recusandae rem repellendus reprehenderit repudiandae similique temporibus tenetur totam vel voluptatibus voluptatum! Quia, saepe totam!
                    ...
                    <div class="flex items-center justify-between mt-6">
                        ...
                        <div class="flex items-center space-x-2">
                            ...
                            <button class="relative bg-gray-100 border border-gray-200 hover:bg-gray-200 rounded-full h-7 py-2 px-3 transition duration-150 ease-in">
